...
public class DataCheck {
	/** 日志对象 */
	protected static Logger logger = LoggerFactory.getLogger(DataCheck.class);
	...
	public static boolean isPhoneNumber(String string) {
		Pattern pattern = Pattern.compile("^(13[0-9]|14[57]|15[012356789]|17[013678]|18[0-9])[0-9]{8}$"); // 手机号
